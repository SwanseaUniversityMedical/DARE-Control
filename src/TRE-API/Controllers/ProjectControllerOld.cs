...
namespace TRE_API.Controllers
{
    ...
    public class ProjectControllerOld : Controller
    {
        ...
        public ProjectControllerOld(IDareClientWithoutTokenHelper dareclient, ApplicationDbContext applicationDbContext)
        {
